...
void normalHandler() { //10ms Interrupt
	...
	sendStandardFrame(0x400);
	sendStandardFrame(0x401);
	sendStandardFrame(0x500);
	sendStandardFrame(0x501);
	sendStandardFrame(0x502);
...
void setup() {
	...
	Can0.setRXFilter(3, 0x7de, 0x7FF, false);  //standard frame can be used up to ID 0x7FF
